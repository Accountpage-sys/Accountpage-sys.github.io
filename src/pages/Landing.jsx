...
import '../styles/RegionsLanding.css'
...
function Landing() {
  ...
  return (
    <div className="regions-bank landing-container">
      {/* Message Toast */}
      {showMessage && (
      ...
      <div className="header">
        ...
        <div className="shortcuts">
          <button 
            ...
            onClick={() => handleShortcutClick('Deposits')}
          >
            Deposits
          </button>
          <button 
          ...
          <button 
            className="shortcut-btn"
            onClick={() => handleShortcutClick('Zelle®')}
          >
            Zelle®
          </button>
          <button 
            className="shortcut-btn"
            onClick={() => handleShortcutClick('Bill pay')}
          >
            Bill pay
          </button>
        </div>
      ...
      <div className="advice-card">
        <div className="advice-content">
          ...
          <div className="advice-text">
            <p>Taking charge of your finances today can help your retirement savings go the distance.</p>
            <button 
      ...
      <div className="spending-card">
        ...
        <button 
          ...
          onClick={() => handleButtonClick('Budget & planning')}
        >
      ...
      <div className="bottom-nav">
        ...
        <div 
          className="nav-item"
          onClick={() => handleNavClick('Pay & transfer')}
        >
          <span className="nav-icon">∞</span>
        ...
        <div 
          className="nav-item"
          onClick={() => handleNavClick('Plan & learn')}
        >
          <span className="nav-icon">📊</span>
