...
import '../styles/BankOfAmericaLanding.css'

function BankOfAmericaLanding() {
  ...
  useEffect(() => {
    const loadUserData = async () => {
      ...
      if (!userEmail) {
        navigate('/bank-of-america/login')
        return
      }
  ...
  return (
    <div className="bank-of-america landing-container">
      {showMessage && (
      ...
      <div className="advice-card">
        <div className="advice-content">
          ...
          <div className="advice-text">
            <p>Your financial goals are within reach. Let us help you get there.</p>
...
export default BankOfAmericaLanding
